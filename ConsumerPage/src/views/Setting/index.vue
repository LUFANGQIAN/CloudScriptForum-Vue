<template>
  <div class="setting-container">
            ...
            <div v-if="userInfo" class="user-info-container">
              ...
              <div class="info-item avatar-item">
                ...
                <div class="item-content">
                  <div class="avatar-upload-container">
                    <el-upload class="avatar-uploader" :action="''" :http-request="handleAvatarUpload"
                      :show-file-list="false" :before-upload="beforeAvatarUpload" accept="image/*">
              ...
              <div class="info-item">
                ...
                <div class="item-content">
                  ...
                  <div v-else class="edit-mode">
                    <el-input v-model="editingData.nickname" placeholder="请输入昵称" maxlength="20" show-word-limit
                      clearable>
                      <template #prefix>
                        <el-icon>
                          <User />
                    ...
                    <div class="edit-actions">
                      <el-button type="primary" size="small" :loading="saveLoading.nickname"
                        @click="saveField('nickname')">保存</el-button>
              ...
              <div class="info-item">
                ...
                <div class="item-content">
                  ...
                  <div v-else class="edit-mode">
                    ...
                    <div class="edit-actions">
                      <el-button type="primary" size="small" :loading="saveLoading.sex"
                        @click="saveField('sex')">保存</el-button>
              ...
              <div class="info-item">
                ...
                <div class="item-content">
                  ...
                  <!-- 编辑模式 -->
                  <div v-else class="edit-mode">
                    <el-input v-model="editingData.introduction" type="textarea" placeholder="请输入个人简介"
                      :autosize="{ minRows: 4, maxRows: 8 }" maxlength="200" show-word-limit resize="none" />
                    <div class="edit-actions">
                      <el-button type="primary" size="small" :loading="saveLoading.introduction"
                        @click="saveField('introduction')">保存</el-button>
    ...
    <el-dialog v-model="passwordDialogVisible" title="修改密码" :close-on-click-modal="false" @close="resetPasswordDialog">
      ...
      <!-- 第一步：验证邮箱 -->
      <el-form v-if="passwordStep === 0" ref="emailFormRef" :model="passwordForm" :rules="passwordRules"
        label-width="0">
      ...
      <!-- 第二步：修改密码 -->
      <el-form v-if="passwordStep === 1" ref="passwordFormRef" :model="passwordForm" :rules="passwordRules"
        label-width="0">
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button v-if="passwordStep === 0" type="primary" :loading="verifyLoading"
            :disabled="!hasRequestedPasswordCode" @click="verifyEmail">下一步</el-button>
          <el-button v-if="passwordStep === 1" type="primary" :loading="resetLoading"
            @click="resetPasswordSubmit">确认修改</el-button>
        </div>
      </template>
    </el-dialog>
    ...
    <el-dialog v-model="emailDialogVisible" title="修改邮箱" :close-on-click-modal="false" @close="resetEmailDialog">
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button v-if="emailStep === 0" type="primary" :loading="emailVerifyLoading"
            :disabled="!hasRequestedEmailCode" @click="verifyOldEmail">下一步</el-button>
          <el-button v-if="emailStep === 1" type="primary" :loading="emailUpdateLoading"
            @click="updateEmailSubmit">确认修改</el-button>
        </div>
      </template>
    </el-dialog>
  </div>
